...
function QuestionSection({ mockInterviewQuestion, activeQuestionIndex }) {
  ...
  console.log("interview Question:", mockInterviewQuestion.interviewQuestions);
      ...
      <div className="p-5 border rounded-lg">
          ...
          {mockInterviewQuestion ? (
            ...
            mockInterviewQuestion.map(
              (questionObj, index) => (
                <div key={index}>
                  <h3
                    className={`p-2 xl:py-5 lg:py-3 md:py-4 border rounded-full text-xs md:text-sm text-center cursor-pointer ${
        ...
        <div>
          {mockInterviewQuestion?.length > 0 && (
            <>
              <h2 className="my-5 text-md lg:text-lg font-semibold">
                {
